...
describe("Given I am on a page", function () {
    describe("When I use the calendar component", function () {
        test("Then the calendar should be rendered", function () {
            render(React.createElement(Calendar, { languageChoice: "fr", yearMin: 1990, yearMax: 2080, returnFormat: "dd/MM/yyyy", classToggle: "calendar", defaultDate: new Date() }));
        ...
        test("Then, if the maximum year is greater than current year + 1000, then we must have an error displayed", function () {
            expect(function () {
                render(React.createElement(Calendar, { languageChoice: "fr", yearMin: 1990, yearMax: new Date().getFullYear() + 2000, returnFormat: "dd/MM/yyyy", classToggle: "calendar", defaultDate: new Date() }));
        ...
        test("Then, if the minimum year is lower than current year - 1000, then we must have an error displayed", function () {
            expect(function () {
                render(React.createElement(Calendar, { languageChoice: "fr", yearMin: new Date().getFullYear() - 2000, yearMax: 2030, returnFormat: "dd/MM/yyyy", classToggle: "calendar", defaultDate: new Date() }));
        ...
        test("Then, if the chosen language is not available in the proposed languages, then an error is displayed", function () {
            expect(function () {
                render(React.createElement(Calendar, { languageChoice: "france", yearMin: 2001, yearMax: 2030, returnFormat: "dd/MM/yyyy", classToggle: "calendar", defaultDate: new Date() }));
        ...
        test("Then, if the format the user wants is not available in date-fns, then an error is displayed", function () {
            expect(function () {
                render(React.createElement(Calendar, { languageChoice: "fr", yearMin: 2001, yearMax: 2030, returnFormat: "day/month/years", classToggle: "calendar", defaultDate: new Date() }));
