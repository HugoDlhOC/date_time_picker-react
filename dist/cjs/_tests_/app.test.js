...
describe("Given I am on a page", function () {
    describe("When I use the calendar component", function () {
        test("Then the calendar should be rendered", function () {
            (0, react_1.render)(react_2["default"].createElement(Calendar_1["default"], { languageChoice: "enUS", yearMin: 1990, yearMax: 2080, returnFormat: "dd/MM/yyyy", defaultDate: new Date(), labelContent: "Date", nameInput: "calendar" }));
            //@ts-ignore
        ...
        test("Then, if the maximum year is greater than current year + 1000, then we must have an error displayed", function () {
            expect(function () {
                (0, react_1.render)(react_2["default"].createElement(Calendar_1["default"], { languageChoice: "enUS", yearMin: 1990, yearMax: new Date().getFullYear() + 2000, returnFormat: "dd/MM/yyyy", defaultDate: new Date(), labelContent: "Date", nameInput: "calendar" }));
        ...
        test("Then, if the minimum year is lower than current year - 1000, then we must have an error displayed", function () {
            expect(function () {
                (0, react_1.render)(react_2["default"].createElement(Calendar_1["default"], { languageChoice: "enUS", yearMin: new Date().getFullYear() - 2000, yearMax: 2030, returnFormat: "dd/MM/yyyy", defaultDate: new Date(), labelContent: "Date", nameInput: "calendar" }));
        ...
        test("Then, if the chosen language is not available in the proposed languages, then an error is displayed", function () {
            expect(function () {
                (0, react_1.render)(react_2["default"].createElement(Calendar_1["default"], { languageChoice: "france", yearMin: 2001, yearMax: 2030, returnFormat: "dd/MM/yyyy", defaultDate: new Date(), labelContent: "Date", nameInput: "calendar" }));
        ...
        test("Then, if the format the user wants is not available in date-fns, then an error is displayed", function () {
            expect(function () {
                (0, react_1.render)(react_2["default"].createElement(Calendar_1["default"], { languageChoice: "enUS", yearMin: 2001, yearMax: 2030, returnFormat: "day/month/years", defaultDate: new Date(), labelContent: "Date", nameInput: "calendar" }));
