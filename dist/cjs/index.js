...
var Calendar = function () {
    return (react_1["default"].createElement(react_redux_1.Provider, { store: store_1.store },
        react_1["default"].createElement(Calendar_1["default"], { languageChoice: "fr", yearMin: 2001, yearMax: 2120, returnFormat: "dd/MM/yyyy", classToggle: "calendar", defaultDate: new Date() })));
};
